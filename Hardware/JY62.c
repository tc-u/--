        ...
        if (jy62RxIndex == 11) {
            ...
            if (jy62RxBuffer[0] == 0x55 && jy62RxBuffer[1] == 0x53) {
                ...
                if (checksum == jy62RxBuffer[10]) {
                    // 解析数据
                    jy62Data.yaw = ((int16_t)(jy62RxBuffer[3] << 8 | jy62RxBuffer[2])) / 100.0f;
                    jy62Data.roll = ((int16_t)(jy62RxBuffer[5] << 8 | jy62RxBuffer[4])) / 100.0f;
                    jy62Data.pitch = ((int16_t)(jy62RxBuffer[7] << 8 | jy62RxBuffer[6])) / 100.0f;
